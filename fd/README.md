...
列表项：
- 用户栏：ID、用户名、邮箱;编辑信息按钮、编辑与组的关联关系按钮、删除按钮
- 组栏：ID、名称;编辑信息按钮、编辑与用户的关联关系按钮、编辑与权限的关联关系按钮、删除按钮
- 权限栏：ID、名称;编辑信息按钮、编辑与组的关联关系按钮、删除按钮
...
点击一个元素后，其相邻元素分为上下两栏分别为已关联与未关联  
如果同时点击了用户和权限，则组栏上方是同时关联了选中用户和权限的组
